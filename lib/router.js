...
// 大学采购
router.get('/procurement/zjdx', require('./routes/procurement/zjdx'));
router.get('/procurement/yct', require('./routes/procurement/yct'));
router.get('/procurement/shuzhou', require('./routes/procurement/shuzhou'));
router.get('/procurement/lynk', require('./routes/procurement/lynk'));
router.get('/procurement/zhejiang', require('./routes/procurement/zhejiang'));
router.get('/procurement/anhui', require('./routes/procurement/anhui'));
